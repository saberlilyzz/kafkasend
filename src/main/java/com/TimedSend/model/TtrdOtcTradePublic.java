...
public class TtrdOtcTradePublic implements Serializable {
    ...
    public  String bndNetprice;

    /**
     * 应计利息
     */

    public  String bndAiamount;
    ...
    public String getBndNetprice() {
        return bndNetprice;
    }

    public void setBndNetprice(String bndNetprice) {
        this.bndNetprice = bndNetprice;
    }

    public String getBndAiamount() {
        return bndAiamount;
    }

    public void setBndAiamount(String bndAiamount) {
        this.bndAiamount = bndAiamount;
    }
